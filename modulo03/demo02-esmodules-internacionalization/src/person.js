export default class Person {
    ...
    formatted(language) {
        ...
        return {
            ...
            from: new Intl
                .DateTimeFormat(language, { year: 'numeric', month: 'long', day: '2-digit' })
    ...
    // Membro estático, já que não trabalha com a instância de Person!!
    static generateInstanceFromString(text) {
        const EMPTY_SPACE = ' '
        const [id, vehicles, kmTraveled, from, to] = text.split(EMPTY_SPACE)
        const person = new Person({
            id, vehicles: vehicles.split(','), kmTraveled, from, to
        })
